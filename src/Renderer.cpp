...
#include "glsl/static_vert.inl"
#include "glsl/morph_vert.inl"
#include "glsl/skinning_vert.inl"
#include "glsl/model_frag.inl"
...
{
	try {
        mShaders[MeshType::STATIC] = gl::GlslProg::create(static_vert, model_frag);
        mShaders[MeshType::SKELETAL] = gl::GlslProg::create(skinning_vert, model_frag);
        mShaders[MeshType::MORPHED] = gl::GlslProg::create(morph_vert, model_frag);
	}
